...
class Tools{
    ...
    addTaskToDatabase(task_object_to_send, user_email){
        ...
        fetch('http://51.77.48.179:8080/task', {
            method: 'POST',
    ...
    getTaskFromDatabase(diary_callback, user_email){
        try {
            fetch('http://51.77.48.179:8080/task_by_email',{
                method: 'POST',
    ...
    addDiaryAnswersToDatabase(user_email){
        ...
        fetch('http://51.77.48.179:8080/diary_notes', {
            method: 'POST',
    ...
    addLongTermGoalToDatabase(long_term_goal_to_send, user_email){
        fetch('http://51.77.48.179:8080/long_term_goal', {
            method: 'POST',
    ...
    addProgresTaskFromDatabase(user_email){
        fetch('http://51.77.48.179:8080/task_to_progres', {
            method: 'POST',
